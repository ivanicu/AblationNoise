...
**What replaces it is the distribution, and that *is* informative.** Chi-square `45.292` against a
...
```
PROVENANCE 36   SCOPE 29   STATISTIC 30   CONTROL 27   UNCLASSIFIED 4   INTERVENTION 4
                                                     expected 21.6667 each
```
