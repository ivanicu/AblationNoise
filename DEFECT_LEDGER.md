...
**What replaces it is the distribution, and that *is* informative.** Chi-square `66.83050847457626` against a
...
```
PROVENANCE 41   SCOPE 42   STATISTIC 46   CONTROL 40   UNCLASSIFIED 4   INTERVENTION 4
