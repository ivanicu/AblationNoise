...
**What replaces it is the distribution, and that *is* informative.** Chi-square `42.476` against a
...
```
PROVENANCE 33   SCOPE 29   STATISTIC 30   CONTROL 26   UNCLASSIFIED 4   INTERVENTION 4
                                                     expected 21.0000 each
```
