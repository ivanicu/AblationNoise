...
**What replaces it is the distribution, and that *is* informative.** Chi-square `56.53846153846154` against a
...
```
PROVENANCE 38   SCOPE 35   STATISTIC 40   CONTROL 35   UNCLASSIFIED 4   INTERVENTION 4
