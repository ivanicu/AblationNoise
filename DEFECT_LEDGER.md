...
```
    ...
    SCOPE          41      which population the claim covers
...
**What replaces it is the distribution, and that *is* informative.** Chi-square `66.38636363636364` against a
...
```
PROVENANCE 41   SCOPE 41   STATISTIC 46   CONTROL 40   UNCLASSIFIED 4   INTERVENTION 4
