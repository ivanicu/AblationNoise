...
**What replaces it is the distribution, and that *is* informative.** Chi-square `51.583` against a
...
```
PROVENANCE 38   SCOPE 31   STATISTIC 36   CONTROL 31   UNCLASSIFIED 4   INTERVENTION 4
