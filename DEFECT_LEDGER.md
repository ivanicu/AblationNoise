...
**What replaces it is the distribution, and that *is* informative.** Chi-square `45.748` against a
...
```
PROVENANCE 36   SCOPE 29   STATISTIC 31   CONTROL 27   UNCLASSIFIED 4   INTERVENTION 4
                                                     expected 21.8333 each
```
