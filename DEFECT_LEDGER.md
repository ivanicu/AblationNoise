...
**What replaces it is the distribution, and that *is* informative.** Chi-square `51.392` against a
...
```
PROVENANCE 38   SCOPE 31   STATISTIC 36   CONTROL 30   UNCLASSIFIED 4   INTERVENTION 4
                                                     expected 23.8333 each
```
