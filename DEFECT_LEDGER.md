...
**What replaces it is the distribution, and that *is* informative.** Chi-square `52.714285714285715` against a
...
```
PROVENANCE 38   SCOPE 32   STATISTIC 37   CONTROL 32   UNCLASSIFIED 4   INTERVENTION 4
