...
`66` rows, `35` of them found by the author reading the object, classified by the author, against
...
there*, and the `10.6%` outside-reader fraction is a floor on the true rate, not an estimate. Correct.
