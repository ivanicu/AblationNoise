<!-- unbacked-ok: 41.27 41.08 40.30 38.03 37.86 37.56 37.17 36.85 36.76 36.28 36.11 36.11 36.11 36.11 36.23 36.12 36.08 36.07 36.10 35.99 35.99 36.07 36.06 36.07 35.86 35.69 35.71 35.53 34.59 34.16 34.72 35.02 35.38 36.74 2006 1719 1713 1671 1669 1683
...
`measured_false_pass_rate = 41.27`
...
`36.11` -> `36.28` -> `36.76` -> `36.85` -> `37.17` -> `37.56` -> `37.86` -> `38.03` -> `40.30` -> `41.08` -> `41.27`, 2026-07-28 into 2026-07-29. The first step was `margin_normalisation()` gaining
